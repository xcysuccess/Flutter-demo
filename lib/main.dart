import 'package:flprovider/RouterTestRoute.dart';
import 'package:flprovider/TipRoute.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        routes: {
          ...
          "provider_route": (context) => ProviderRoute(),
        },
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FlatButton(
              child: Text("open new RouterTestRoute"),
              textColor: Colors.blue,
              onPressed: () {
                //导航到新路由
                Navigator.push(context, MaterialPageRoute(builder: (context) {
            ...
            FlatButton(
              ...
              onPressed: () {
                ...
                Navigator.of(context)
                    .pushNamed("provider_route", arguments: "hi");
              },
            ),
          ],
        ),
